...
export function Header() {
  ...
  useEffect(() => {
    // Stay out of the way over the product stage; go solid once past it.
    const onScroll = () => {
      const stage = document.getElementById("produkter");
      const past = stage ? stage.offsetTop + stage.offsetHeight - 140 : 40;
      setSolid(window.scrollY > past);
    };
    onScroll();
